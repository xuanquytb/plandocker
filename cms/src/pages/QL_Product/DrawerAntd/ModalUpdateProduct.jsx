...
const ModalUpdateProduct = ({ input, visible, onClose, onUpdate }) => {
  ...
  const brands = [
    {
      id: 1,
      nameManufacturer: "Lan Hoàng",
    },
    {
      id: 2,
      nameManufacturer: "ELISE",
    },
    {
      id: "3",
      nameManufacturer: "JUNO",
    },
  ];
      ...
      >
        ...
        >
          ...
          <Row gutter={16}>
            ...
            <Col span={6}>
              <Form.Item name="quantitynew" label="Số lượng sản phẩm mới nhập">
                <Input placeholder={quantitynew} disabled allowClear />
              </Form.Item>
            </Col>
          </Row>
          <Row gutter={16}>
            <Col span={8}>
              <Form.Item name="quantity" label="Số lượng sản phẩm trong kho">
                <Input allowClear disabled={true} />
              </Form.Item>
            </Col>
            <Col span={8}>
              <Form.Item name="quantityupdate" label="Số lượng mới">
                <Input
