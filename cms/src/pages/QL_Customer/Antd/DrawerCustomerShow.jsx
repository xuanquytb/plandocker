  ...
  return (
    ...
    >
      <Image
        ...
        src={`${process.env.REACT_APP_BACKEND}api/user/${input.nameAvata}`}
      />
      <Descriptions title="Thông tin tài khoản" layout="vertical" bordered>
        ...
        <Descriptions.Item label="Giới tính">{input.sex}</Descriptions.Item>
        ...
        <Descriptions.Item label="Địa chỉ">{input.address}</Descriptions.Item>
      </Descriptions>
