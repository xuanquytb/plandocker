...
const VerticalLayout = props => {
  ...
  const bgColorCondition = useMemo(() => navbarColor !== '' && navbarColor !== 'light' && navbarColor !== 'white', [navbarColor])
  ...
  return (
    <div
      className={classnames(
        ...
        {
          [navbarWrapperClasses[navbarType]]: navbarWrapperClasses[navbarType],
          'navbar-floating': !navbarWrapperClasses[navbarType],
          [footerClasses[footerType]]: footerClasses[footerType],
          'footer-static': !footerClasses[footerType],
          // Modern Menu
      ...
      <Navbar
        ...
        className={classnames(
          'header-navbar navbar align-items-center navbar-shadow', {
            [navbarClasses[navbarType]]: navbarClasses[navbarType],
            'floating-nav': !navbarClasses[navbarType]
          }
        )}
      >
